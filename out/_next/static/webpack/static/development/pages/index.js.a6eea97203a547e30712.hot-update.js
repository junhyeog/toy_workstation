...
var HandsContainer = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "Hands__HandsContainer",
...
})(["position:absolute;width:1px;height:", "px;background:#34cdab;border-radius:100%;top:10px;transform:rotate(", ") translate3d(-50%,0,0);transform-origin:0px bottom;"], function (props) {
  return 150 - props.borderWidth;
}, function (props) {
...
})(["position:absolute;width:3px;height:", "px;background:#fff;border-radius:100%;top:50px;transform:rotate(", ") translate3d(-50%,0,0);transform-origin:0px bottom;"], function (props) {
...
var HourHand = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  componentId: "sc-16z571e-3"
})(["position:absolute;width:5px;height:", "px;background:#fff;border-radius:100%;top:70px;transform:rotate(", ") translate3d(-50%,0,0);transform-origin:0px bottom;"], function (props) {
...
//# sourceMappingURL=index.js.a6eea97203a547e30712.hot-update.js.map